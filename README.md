...
- [Node WebSocket Game Server](https://github.com/mavisakalyan/node-ws-gameserver): Multiplayer WebSocket relay with rooms, msgpack binary protocol, and rate limiting. One-click Railway template.
